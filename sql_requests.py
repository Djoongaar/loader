...
MAIN_CUSTOMERS_INNS = (
        ...
        "7701885820",  # АО "МОСИНЖПРОЕКТ"
        "7704515009",  # Департамент конкурентной политики
        "5000001525",  # Мосавтодор
        "5031035549",  # "ФКУ УПРДОР МОСКВА - НИЖНИЙ НОВГОРОД"
        "5024063954",  # ГУП МО "МОДЦ"

        # # ========== САНКТ-ПЕТЕРБУРГ и СЕВЕРО-ЗАПАД ===============
        # "7806215195",  # ГБУ МОСТОТРЕСТ
        # "7830001853",  # КОМИТЕТ ПО РАЗВИТИЮ ТРАНСПОРТНОЙ ИНФРАСТРУКТУРЫ САНКТ-ПЕТЕРБУРГА
